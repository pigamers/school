...
export default function CourseCreation(params) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    Axios.post('http://65.2.30.68:8000/', {data})
    .then(res => {
      console.log(res)
        ...
        <div>
          ...
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form className="space-y-6" action="#" onSubmit={handleSubmit}>
              ...
              <div>
              <div className="flex items-center justify-between">
                  <label htmlFor="startTime" className="block text-lg font-medium leading-6 text-gray-900">
                    Start Time
                  </label>
                </div>
                <div className="mt-2">
              ...
              <div>
              <div className="flex items-center justify-between">
                  <label htmlFor="endTime" className="block text-lg font-medium leading-6 text-gray-900">
                    End Time
                  </label>
                </div>
                <div className="mt-2">

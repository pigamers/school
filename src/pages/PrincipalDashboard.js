...
export default function PrincipalDashboard() {
    ...
    return(
        <div>
            ...
            <div className={`${close ? "hidden ": "block "} fixed top-0 bottom-0 lg:left-0 p-2 w-2/3 md:w-1/5 text-center bg-gray-900`}>
                <div className="text-gray-100 text-xl">
                    <div className="p-2.5 mt-1 flex items-center">
                        <i className="px-2 py-1 rounded-md bg-blue-600">
                            <RxDashboard size={"30"} />
                        </i>
                        <h1 className="font-bold text-gray-200 text-xl md:text-xl pl-5">Principal Dashboard</h1>
                        <i className="cursor-pointer ml-20 lg:hidden" onClick={closeSideBar}>

...
export default function AdminDashboard() {
    ...
    return(
        <div>
            ...
            <div className={`${close ? "hidden ": "block "} fixed top-0 bottom-0 lg:left-0 p-2 w-[400px] md:w-[300px] text-center bg-gray-900`}>
                <div className="text-gray-100 text-xl">
                    <div className="p-2.5 mt-1 flex items-center">
                        <i className="px-2 py-1 rounded-md bg-blue-600">
                            <RxDashboard size={"30"} />
                        </i>
                        <h1 className="font-bold text-gray-200 text-xl pl-5">Admin Dashboard</h1>
                        <i className="cursor-pointer ml-24 lg:hidden" onClick={closeSideBar}>
                ...
                <div className="p-2.5 flex mt-3 items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-center">
                    <i className=" text-sm"></i>
                    <span className="text-xl ml-4 text-gray-200 font-bold">Institute</span>
                </div>
                <div className="p-2.5 flex mt-3 items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-center">
                    <i className=" text-sm"></i>
                    <span className="text-xl ml-4 text-gray-200 font-bold">Institute Admin</span>
                </div>
                <div className="p-2.5 flex mt-3 items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-center">
                    <i className=" text-sm"></i>
                    <span className="text-xl ml-4 text-gray-200 font-bold">Student Details</span>
                </div>
                <div className="p-2.5 flex mt-3 items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-center">
                    <i className=" text-sm"></i>
            ...
            <div className="flex flex-col justify-center bg-slate-300 p-10 md:pl-36 items-center">
                <div className="p-5 mt-10 md:mt-0 ml-44 shadow-xl w-60 shadow-blue-300 border-4 rounded-lg">
                    <h1 className="text-center font-bold text-2xl">Welcome</h1>
                </div>
                <div className="p-5 bg-slate-300">
                <div class="p-5 ml-44 space-x-16 flex flex-row overflow-hidden">
                <div class="px-6 py-4 text-center shadow-blue-300 border-4 rounded-lg">
                <div class="font-bold text-xl mb-2">Institutes</div>
                <p class="text-gray-700 text-base">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil.
                </p>
                </div>
                <div class="px-6 py-4 text-center shadow-blue-300 border-4 rounded-lg">
                <div class="font-bold text-xl mb-2">Principal</div>
                <p class="text-gray-700 text-base">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil.
                </p>
                </div>
